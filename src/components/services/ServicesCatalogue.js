...
import Photo6 from '../../images/services/media-montage.png'
import Photo7 from '../../images/services/karaoke.png'
import Photo8 from '../../images/services/event-planning.png'
    ...
    return (
        <div id="container" className="services__container__sub">
                <div className="services__container__catalogue">
                    ...
                    <Card title="MEDIA MONTAGE" subtitle="Receive a custom directed and edited short video for your event consisting of professionally shot photo or video." image={Photo6}/>
                    <Card title="KARAOKE" subtitle="Lyrics to your favorite songs will be displayed on a plasma screen TV. Makes for a great sing-along event!" image={Photo7}/>
                    <Card title="EVENT PLANNING" subtitle="Professionally-curated events make the cut! We will architect the moment of your lifetime." image={Photo8}/>
                </div>
        </div>
    )
}
